...
public final class Suit implements Comparable {
    ...
    /**
     * The symbol associated with this suit. Returns the symbol, which usually
     * constitutes a single character, in the form of a string. Symbol is used for
     * the construction of the filenames of the card images.
     *
     ...
     * @return < 0 if this suit is lower than the other suit, 0 if the suits are the
     *         same, or > 0 if this suit is higher than the other suit.
     */
