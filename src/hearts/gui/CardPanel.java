...
/**
 * Class extending JPanel that helps render card image on the GUI application display.
 */
public class CardPanel extends JPanel{
    ...
    /**
     * Constructs a CardPanel object based on hearts.model.Card object.
     * Called by GameGUI and CardPanel is used for rendering card image on the user interface
    ...
    /**
     * Renders the card to be represented within the card panel.
